...
$query = "SELECT sales.product_id, sales.sale_amount AS amount, sales.sale_date, products.name AS product_name
          FROM sales 
        ...
        <?php if (mysqli_num_rows($result) > 0): ?>
            <?php while ($row = mysqli_fetch_assoc($result)): ?>
                <div class="sale-notification">
                    ...
                    <p>Sold for <strong>Ksh.<?php echo htmlspecialchars($row['amount']); ?></strong></p>
